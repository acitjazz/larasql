    ...
    >
      <div class="relative w-full max-w-full flex items-center pt-5 pl-5">
        <div class="flex items-center">
            <span class="w-10 h-10 bg-gray-100 border border-gray-200 mr-3 flex items-center justify-center rounded"><i class="fa fa-ethernet"></i></span>
        ...
        <div class="px-4 pb-10 max-w-[600px] mx-auto w-full">
            <div class="h-auto lg:h-[250px] mb-5 relative flex-col lg:flex-row flex items-center w-full">
                <div class="w-[200px] mx-auto lg:w-4/12"> <canvas id="pie-chart-service"></canvas></div>
                <div class="w-full lg:w-6/12 mx-7" id="legend-container-service"></div>
            </div>
        </div>
    </div>
  </template>
...
export default {
  ...
  methods:{
    async fetchBar(){
        ...
        const res = await axios.get(route('statistik.service'));
        ...
        afterUpdate(chart, args, options) {
            ...
            let config = {
                ...
                htmlLegend: {
                    ...
                    containerID: 'legend-container-service',
                },
                legend: {
                    display: false,
                }
            ...
            let ctx = document.getElementById("pie-chart-service").getContext("2d");
