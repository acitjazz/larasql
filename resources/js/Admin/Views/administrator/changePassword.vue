...
const submit = () => {
    form.post(route('administrator.update.password',{administrator: props.administrators}), {
          ...
          <form class="flex flex-wrap mt-4"  @submit.prevent="submit">
            <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded" >
                    <div class="p-7 text-white bg-primary" v-if="message">
                        {{ message }}
                    </div>
                    ...
                    <div class="block w-full px-7 py-5" :class="{hidden : tab != 'content'}">
                        <div class="block mt-4">
                            <div class="flex items-center">
                                <InputLabel for="role" class="!m-0" value="Old Password" />
                            ...
                            <TextInput id="old_password" type="password" class="mt-1 block w-full" v-model="form.old_password"  autofocus />
                            <InputError class="mt-2" :message="form.errors.old_password" />
                        </div>

                        <div class="block mt-4">
                            <div class="flex items-center">
                                <InputLabel for="role" class="!m-0" value="New Password" />
                                <Tooltip :custom="true" :data="{message:'The password field must contain at least one uppercase, one lowercase letter, special character, number and minimum 8 characters, also not contain your name or your birthday'}"></Tooltip>
                            </div>
                        ...
                        <div class="block mt-4">
                            <div class="flex items-center">
                                <InputLabel for="role" class="!m-0" value="Confirm New Password" />
                                <Tooltip :custom="true" :data="{message:'The password field must contain at least one uppercase, one lowercase letter, special character, number and minimum 8 characters, also not contain your name or your birthday'}"></Tooltip>
                            </div>
